...
int main()
{
    ...
    if(0)
    {
        ...
        /*
        GLint ebo2;
        glGetIntegerv(GL_ELEMENT_ARRAY_BUFFER, &ebo2);
    ...
    if (0)
    {
        ...
        */
        ...
        while (true)
        {
            ...
            //glm::mat4 projection = glm::perspective(glm::radians(camera.Zoom), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
            //glm::mat4 view = camera.GetViewMatrix();
            glm::mat4 projection(1.30229, 0.00, 0.00, 0.00,
                0.00, 1.73205, 0.00, 0.00,
                0.00, 0.00, 0.03448, 10.34483,
                0.00, 0.00, -1.00, 0.00);
            //projection = projection * glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -50.0f));
