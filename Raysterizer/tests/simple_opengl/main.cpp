...
/*
    ...
    Shader lightingShader("resources/shaders/light_casters.vs", "resources/shaders/light_casters.fs");
...
int main()
{
    //Test();
    auto lib = LoadLibrary("../opengl32.dll");
    //auto lib = LoadLibrary("../Raysterizer.dll");
    //Test();
    ...
    //Model ourModel(FileSystem::getPath("resources/objects/cyborg/cyborg.obj"));
    Model ourModel2(FileSystem::getPath("resources/objects/cornell_box/cornell_box.obj"));
    //Model ourModel2(FileSystem::getPath("resources/objects/backpack/backpack.obj"));
    Model ourModel(FileSystem::getPath("resources/objects/planet/planet.obj"));
    //Model ourModel2(FileSystem::getPath("resources/objects/planet/planet.obj"));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //auto m = glm::transpose(projection * view * model);
        /*
        auto m = projection * view * model;
        auto v = glm::vec4(ourModel.meshes[0].vertices[0].Position, 1.0f);
        auto v0 = m[0] * v;
        auto v1 = m[1] * v;
        auto v2 = m[2] * v;
        auto v3 = m[3] * v;

        auto t0 = m[0][0] * v[0] + m[0][1] * v[1] + m[0][2] * v[2] + m[0][3] * v[3];
        auto t1 = m[1][0] * v[0] + m[1][1] * v[1] + m[1][2] * v[2] + m[1][3] * v[3];
        auto t2 = m[2][0] * v[0] + m[2][1] * v[1] + m[2][2] * v[2] + m[2][3] * v[3];
        auto t3 = m[3][0] * v[0] + m[3][1] * v[1] + m[3][2] * v[2] + m[3][3] * v[3];

        auto t = v * m;
        */
        
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(3.0f, -3.0f, 0.0f)); // translate it down so it's at the center of the scene
